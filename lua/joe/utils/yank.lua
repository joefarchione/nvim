...
M.get_buffer_absolute = function() return vim.fn.expand "%:p" end

M.get_buffer_cwd_relative = function() return vim.fn.expand "%:." end
...
M.simulate_yank_highlight = function()
  ...
  vim.defer_fn(function() vim.api.nvim_buf_clear_namespace(0, ns, 0, -1) end, 150)
end
